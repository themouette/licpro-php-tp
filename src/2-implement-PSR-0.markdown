...
Start by creating the `DOCROOT/projects/practical2` directory and extract
...
Complete `vendor/autoload_namespace.php` to load classes based on the namespaces.
...
> _Hint:_ reuse the work you did before.
